...
public class array6_two_dimensional_QUESTION_ANS_EXCEPTION {
		...
		while (true) {
			try {
				...
				for (int i = 0; i < name.length; i++) {
					...
					System.out.println("\t" + String.format("%5.2f", sungjukdata[i][3]) + "\t"
							+ String.format("%5.2f", sungjukdata[i][4])); // 평균 값
				}
